document.addEventListener("DOMContentLoaded", function () {
  ...
  // URL da API backend hospedada no Railway
  const apiUrl = "https://backend-production-a674.up.railway.app/api/users";
  ...
  userForm.addEventListener('submit', function (e) {
    ...
    fetch("https://backend-production-a674.up.railway.app/api/users", {
      method: 'POST',
      headers: {
